            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="messages_box_area d-flex d-felx" >
                        <div class="messages_list shadow-default radius15">
                            <div class="white_box radius15">
                              
                            <h3 className="fonts30" >Chats</h3>
                    ...
                    <div class="serach_field_2">
                       ...
                       <ul className="overflow-hidden newscroll">
                                    <li className="d-flex">
...
<div className="CHAT_MESSAGE_POPUPBOX" style={{right:"13%"}}>
    <div className="CHAT_POPUP_HEADER shadow-default paddb10 back-white" >
    <div className="MSEESAGE_CHATBOX_CLOSE">
    <i class="fas fa-times"></i>
    </div>
    <div className="d-flex">
    <div className="SMS_thumb">
            <img className="width30" src="img/staf/1.png" alt="" ></img>
        </div>
        <h3 className="text-black">Travis James</h3>
        </div>
    </div>
    ...
    <div className="CHATING_SENDER">
        <div className="SMS_thumb">
            <img src="img/staf/1.png" alt=""></img>
        </div>
    ...
    <div className="CHAT_POPUP_BOTTOM">
        <div className="chat_input_box d-flex align-items-center">
            <div className="input-group">
                <input type="text" className="form-control" placeholder="Write your message" aria-label="Recipient's username" aria-describedby="basic-addon2"></input>
