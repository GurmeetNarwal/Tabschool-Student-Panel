                        ...
                        <div class="white_card_header">
                                ...
                                <div class="single_crm padd10 paddt0">
                                    ...
                                    <div class="crm_body">
                                       ...
                                       <div className=" padd0">
                                       <img src="img/menu-icon/bell.svg " className="bell-width" ></img>
                                       </div>
                                        </div>
...
<div className="row d-flex space-between" >
    ...
    <img className="bell-width" src="img/menu-icon/comment.svg" ></img> <p className="paddtb10 fontauto discuss-padd"> Discuss </p>
